...
\end{table} 
    ...
    \subsubsubsection{Scramjet Engine}
      ...
      \begin{figure}[H]
        ...
        \caption{The compression, combustion, and expansion regions of: (a) turbojet, (b) ramjet, and (c) scramjet engines.\supercite{Img_scramjet}}
