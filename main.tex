...
\begin{document}
  ...
  %\include{parts/interstellar.tex} %%NOTE: SOČ prep %%
  ...
  \begin{figure}[H]
    ...
    \end{center}
    \caption{A heavily edited picture of a "Tweet" by Konstaltin Tsiolkovsky regarding his famous Rocket Equation, posed in an amusing memetic format.}\label{fig:}
  \end{figure}
