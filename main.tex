...
Solid rocket motors use propellants in a single solid mixture, often consisting of a powdered oxidizer (such as ammonium perchlorate) combined with a binder that also acts as fuel. They are mechanically simple, capable of long storage, and deliver high thrust rapidly after ignition. However, they cannot be throttled or shut down once ignited, limiting flexibility.\supercite{humble1995}
