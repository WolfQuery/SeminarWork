      ...
      \begin{table}[H]
        ...
        \begin{threeparttable}
          ...
          \begin{tablenotes}
            ...
            \item[c] Mach number is the ratio of gas speed to local speed of sound (See Equation~\eqref{eq:Mach Number}(Appendix~\ref{app:equations})).
            \item[d] \textit{Specific impulse} is a performance parameter (See Equation~\eqref{eq:Specific Impulse}(Appendix~\ref{app:equations})) 
            \end{tablenotes}
