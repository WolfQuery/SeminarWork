...
\begin{enumerate}
  \item \textbf{Define the design requirements}
    \begin{itemize}
      ...
      \item Select the propellants (for example RP‑1 + LOX, or LH₂ + LOX).  
  ...
  \item \textbf{Document and reflect on the results}
    \begin{itemize}
      ...
      \item Reflect on what you would do differently if you had more time or resources, and what the limits of your design are.
    \end{itemize}
\end{enumerate}
